...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$icon_tflippy_follower$", "InteractionIcons.png", Vec2f(32, 32), 11);
	{
		...
		AddRequirement(s.requirements, "blob", "foodcan", "Scrub Chow", 2);
		s.customButton = true;
		s.buttonwidth = 2;	
		s.buttonheight = 2;
	...
	{
		ShopItem@ s = addShopItem(this, "Retro Style AKM", "$bnak$", "ak_r", "AKM in the style of old weapons.\n\nUses Highcal Ammo.");
	...
	{
		ShopItem@ s = addShopItem(this, "Retro Style SVD", "$svd$", "svd_r", "SVD in the style of old weapons.\n\nUses High Power Rounds.");
