...
void onInit(CBlob@ this)
{
	...
	}
	{
		...
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 6);
	...
	{
		AssemblerItem i("autoshotgun", 4, "UPF Assault Shotgun (2)");
...
void ChickenAssemblerMenu(CBlob@ this, CBlob@ caller)
{
	...
	{
		CGridMenu@ menu = CreateGridMenu(getDriver().getScreenCenterPos() + Vec2f(0.0f, 0.0f), this, Vec2f(4, 9), "Set Assembly");
		if (menu !is null)
		{
