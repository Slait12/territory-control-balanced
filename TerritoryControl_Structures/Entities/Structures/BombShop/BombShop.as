...
void onInit(CBlob@ this)
{
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_mithrilenriched", "Enriched Mithril", 30);
	...
	}
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 500);
		AddRequirement(s.requirements, "blob", "mat_methane", "Methane", 80);
	...
	//	AddRequirement(s.requirements, "blob", "mat_mithrilingot", "Mithril Ingot", 700);
	//	AddRequirement(s.requirements, "blob", "mat_mithrilenriched", "Enriched Mithril", 500);
...
void addTokens(CBlob@ this)
{
	...
	AddIconToken("$moundscroll$", "MoundScroll.png", Vec2f(16, 16), 0, teamnum);
	AddIconToken("$icon_kek$", "Material_ExploNuke.png", Vec2f(16, 16), 0, teamnum);
	AddIconToken("$kek$", "Kek.png", Vec2f(32, 32), 0, 255);
}
