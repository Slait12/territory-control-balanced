...
void onInit(CBlob@ this)
{
	...
	settings.SPREAD_FACTOR = 0.3; //How much spread will increase as you shoot. Formula of increasing is: B_SPREAD * Max:(SPREAD_FACTOR, (Number of shoots * SPREAD_FACTOR)). Does not affect cursor.
	...
	settings.ENLARGE_FACTOR = 0.5; //Multiplier of how much cursor will enlarge as you shoot.
