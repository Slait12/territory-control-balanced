...
void onInit(CBlob@ this)
{
	...
	settings.TOTAL = 90; //Max amount of ammo that can be in a clip
	...
	settings.SPREAD_FACTOR = 0.033; //How much spread will increase as you shoot. Formula of increasing is: B_SPREAD * (Number of shoots * SPREAD_FACTOR). Does not affect cursor.
	...
	settings.RELOAD_SOUND = "UZI_Reloading.ogg"; //Sound when reloading
	...
	this.Tag("pistol");
	this.set_string("CustomSoundPickup", "UZI_Pickup.ogg");
}
