...
void onInit(CBlob@ this)
{
	...
	settings.SPREAD_FACTOR = 0.1; //How much spread will increase as you shoot. Formula of increasing is: B_SPREAD * (Number of shoots * SPREAD_FACTOR). Does not affect cursor.
