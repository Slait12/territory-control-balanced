...
void onInit(CBlob@ this)
{
	...
	settings.AMMO_BLOB = "mat_sammissile"; //Ammunition the gun takes
	...
	//settings.B_DAMAGE = 12.0f; //1 is 1 heart
	...
	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-23, 0); //Where the muzzle flash appears
	...
	this.set_string("ProjBlob", "samrpgrocket");
