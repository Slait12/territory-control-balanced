...
void onInit(CBlob@ this)
{
	...
	this.set_string("ammoIcon", "mat_howitzershell");
    ...
    Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(-20.0f, 15.0f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(-9.0f, 15.0f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(-1.0f, 15.0f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f( 6.0f, 15.0f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f( 13.0f, 15.0f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f( 20.0f, 15.0f));
	...
	CSpriteLayer@ arm = sprite.addSpriteLayer("arm", "ChickenTank_Cannon.png", 65, 8);
	if (arm !is null)
	{
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _unused)
{
	if (bullet !is null)
	{
		...
		Vec2f offset = Vec2f((this.isFacingLeft() ? -1 : 1) * 60, 8); //bullet offset
...
void onDie(CBlob@ this) 
{
	if (isServer())
	{
		...
		CBlob@ wreck = server_CreateBlobNoInit("chickentankwreck");
