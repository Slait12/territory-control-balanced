...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    "incendiaryshell", // bullet config name
	...
	this.set_string("autograb blob", "mat_incendiarybomb");
	this.set_string("ammoIcon", "IncendiaryShell.png");
	...
	if (isServer())
	{
		CBlob@ ammo = server_CreateBlob("mat_incendiarybomb");
		if (ammo !is null)
		{
