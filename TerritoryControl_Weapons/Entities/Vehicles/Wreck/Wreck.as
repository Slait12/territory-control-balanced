...
void onInit(CBlob@ this)
{
	...
	else if (configName == "chargedrillwreck") mats.push_back(HarvestBlobMat(10.0f, "mat_ironingot"));
	else if (configName == "sfcannonwreck") { mats.push_back(HarvestBlobMat(4.0f, "mat_steelingot")); mats.push_back(HarvestBlobMat(10.0f, "mat_ironingot"));}
	...
	AddIconToken("$icon_repair$", "InteractionIcons.png", Vec2f(32, 32), 15);
	{
		...
		else if (configName == "chickentankwreck")
		{
			@s = addShopItem(this, "Repair", "$icon_repair$", "chickentank", "Repair this badly damaged vehicle.");	
			
			AddRequirement(s.requirements, "blob", "mat_ironingot", "Iron Ingot", 35);
			AddRequirement(s.requirements, "blob", "mat_steelingot", "Steel Ingot", 20);
			AddRequirement(s.requirements, "coin", "", "Coins", 1500);
		}
		else if (configName == "chargedrillwreck")
		{
			@s = addShopItem(this, "Repair", "$icon_repair$", "chargedrill", "Repair this badly damaged vehicle.");	
