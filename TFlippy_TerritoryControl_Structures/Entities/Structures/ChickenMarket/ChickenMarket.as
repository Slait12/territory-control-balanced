...
void onInit(CBlob@ this)
{
	...
	this.SetMinimapVars("GUI/Minimap/MinimapIcons.png", 60, Vec2f(8, 8));
	...
	{
		ShopItem@ s = addShopItem(this, "UPF Department Store Partnership Card", "$buyshop$", "buyshop", "Become the UPF Department Store co-leader and receive 20% of its sales!", false, true);
	...
	}
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 4999);
		s.spawnNothing = true;
	}
	{
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		if (spl[0] == "buyshop")
		{
			...
			client_AddToChat("" + callerPlayer.getCharacterName() + " has become the UPF Department Store Partnership Card co-leader and from now will receive 20 percent of its sales!.", SColor(255, 255, 100, 0));
		}
