...
void onTick(CBlob@ this)
{
	...
	if (this.get_bool("security_state")) //&& (this.get_u32("elec") > 50 || this.getTeamNum() >= 7))
	{
		...
		if (this.get_u16("target") != 0)
		{
			CBlob@ t = getBlobByNetworkID(this.get_u16("target"));
			if (t !is null)
			{
				if (t.getTeamNum() == this.getTeamNum()) this.set_u16("target", 0);
			
				if (getGameTime() >= this.get_u32("next_launch") && isVisible(this, t))
				{
					...
					if (ammo > 0)
					{
						if (isServer())
						{
							...
							CBlob@ m = server_CreateBlobNoInit("sam2missile");
