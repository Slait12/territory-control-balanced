...
void onInit(CBlob@ this)
{
	...
	if (!this.exists("mining_hardness")) this.set_u8("mining_hardness", 8);
	if (!this.exists("max_build_length")) this.set_f32("max_build_length", 4.00f);
	if (!this.exists("build delay")) this.set_u32("build delay", 3);
...
void onSetPlayer(CBlob@ this, CPlayer@ player)
{
	if(player !is null)
	{
		player.SetScoreboardVars("ScoreboardIcons.png", 22, Vec2f(16, 16));
	}
}
