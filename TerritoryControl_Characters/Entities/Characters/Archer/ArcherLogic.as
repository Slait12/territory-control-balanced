...
void ManageGrapple(CBlob@ this, ArcherInfo@ archer)
{
	...
	const bool right_click = this.isKeyJustPressed(key_action2) && !this.hasTag("noRMB");
	if (right_click)
	{
		// cancel charging
			...
			else //stuck -> pull towards pos
			{
				...
				if (b !is null)
				{
					...
					if ((b.isKeyJustPressed(key_action1) && !b.hasTag("noLMB")) ||
					        (b.isKeyJustPressed(key_action2) && !b.hasTag("noRMB")) ||
				...
				if (b is null || !b.isAttachedTo(this))
					this.AddForce(force);
...
void ManageBow(CBlob@ this, ArcherInfo@ archer, RunnerMoveVars@ moveVars)
{
	...
	u8 charge_state = archer.charge_state;
	const bool pressed_action2 = this.isKeyPressed(key_action2) && !this.hasTag("noRMB");
	Vec2f pos = this.getPosition();
